  ...
  return (
    <section className="bg-white py-16">
      <div className="w-full mx-auto px-6 md:px-20 text-center relative">
        ...
        <h2 className="md:text-4xl text-2xl font-bold mt-2 mb-12">
          What’s People Say’s
        </h2>
                ...
                <div>
                  <div className="flex items-center mb-4">
                    {Array.from({ length: testimonial.rating }).map((_, i) => (
                      <span key={i} className="text-[#f08a25] text-md md:text-xl mr-1">★</span>
                    ))}
                  </div>
                  <p className="text-gray-800 text-sm md:text-md text-left">
