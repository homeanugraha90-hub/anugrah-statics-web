      ...
      <div className="max-w-6xl py-10 px-4 mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center ">
        ...
        <div className="bg-gray-50 px-6 py-10 rounded-md text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-4">
            <a target="_blank" href="https://www.facebook.com/anugrahhomesjattari1/" className="p-2 border rounded-full hover:bg-gray-200">
              <FaFacebookF />
            </a>
            <a target="_blank" href="https://x.com/anugrahomes01" className="p-2 border rounded-full hover:bg-gray-200">
              <FaTwitter />
            </a>
            <a target="_blank" href="https://www.linkedin.com/in/anugrah-homes-jattari-2bba65383/
" className="p-2 border rounded-full hover:bg-gray-200">
              <FaLinkedinIn />
            </a>
            <a target="_blank" href="https://www.instagram.com/anugr_ahhomes/" className="p-2 border rounded-full hover:bg-gray-200">
              <FaInstagram />
            </a>
            <a target="_blank" href="https://www.pinterest.com/anugrahomes01/" className="p-2 border rounded-full hover:bg-gray-200">
              <FaPinterestP />
            </a>
            <a target="_blank" href="https://www.youtube.com/@AnugrahHomes-Jattar" className="p-2 border rounded-full hover:bg-gray-200">
              <FaYoutube />
            </a>
          </div>
        </div>
