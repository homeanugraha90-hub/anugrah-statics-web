...
export default function AdminFaq() {
  ...
  const fetchFaqs = async () => {
    try {
      const res = await axios.get("https://anugrah-web-site-2.onrender.com/api/faqs");
      setFaqs(res.data);
    } catch (err) {
  ...
  const handleSave = async () => {
    ...
    setLoading(true);
    try {
      await axios.put(`https://anugrah-web-site-2.onrender.com/api/faqs/${selectedFaq._id}`, selectedFaq);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://anugrah-web-site-2.onrender.com/api/faqs/${id}`);
  ...
  const handleAddNew = async () => {
    ...
    try {
      await axios.post("https://anugrah-web-site-2.onrender.com/api/faqs", newFaq);
