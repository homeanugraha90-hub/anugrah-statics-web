...
export default function AdminHome() {
    ...
    const fetchSections = async () => {
        try {
            const res = await axios.get("https://anugrah-web-site-2.onrender.com/api/home");
  ...
  if (type === "images") {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await axios.put(
                `https://anugrah-web-site-2.onrender.com/api/home/${selectedSection.sectionName}`,
                formData,
                                ...
                                <div className="flex gap-2 flex-wrap">
                                    {selectedSection.images.map((img, idx) => (
                                        <div key={idx} className="relative">
                                            <img
                                                src={`https://anugrah-web-site-2.onrender.com/upload/${img}`} // use the correct path
                                                alt={`img-${idx}`}
                        ...
                        {selectedSection.videos && selectedSection.videos.length > 0 && (
                            <div>
                                ...
                                <div className="relative w-64 h-40">
                                    <video
                                        src={`https://anugrah-web-site-2.onrender.com/uploads/${selectedSection.videos[0]}`}
                                        controls
