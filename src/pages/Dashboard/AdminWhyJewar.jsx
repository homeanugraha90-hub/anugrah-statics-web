...
export default function AdminWhyJewar() {
  ...
  const fetchSections = async () => {
    try {
      const res = await axios.get("https://anugrah-web-site-2.onrender.com/api/why-jeware");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.put(
        `https://anugrah-web-site-2.onrender.com/api/why-jeware/${selectedSection.sectionName}`,
        formData,
                ...
                <div className="flex gap-2 flex-wrap">
                  {selectedSection.Images.map((img, idx) => (
                    <div key={idx} className="relative">
                      <img
                        src={`https://anugrah-web-site-2.onrender.com/upload/${img}`}
                        alt={`img-${idx}`}
            ...
            {selectedSection.videos && selectedSection.videos.length > 0 && (
              <div>
                ...
                <div className="relative w-64 h-40">
                  <video
                    src={`https://anugrah-web-site-2.onrender.com/upload/${selectedSection.videos[0]}`}
                    controls
