...
import heroImg from "../assets/gate-1.png";
  ...
  const faqs = [
    {
      ...
      answer:
        "Jewar is Greater Noida’s most promising investment destination near the upcoming Noida International Airport. With planned infrastructure, rising demand, and connectivity, it's a hotspot for high-return real estate investments.",
    },
    {
      faqnumber: 2,
      question: "What lifestyle does Jewar offer?",
      answer:
        "Jewar offers a tranquil lifestyle close to nature with modern infrastructure, recreational parks, cultural venues, and minimal congestion — all while being connected to urban amenities.",
    },
    {
      faqnumber: 3,
      question: "Are plots near Jewar Airport good for both residential and commercial use?",
      answer:
        "Yes, our plots are strategically located just minutes from the airport, making them ideal for both residential and commercial purposes.",
    },
    {
      faqnumber: 4,
      question: "What are the luxurious amenities available?",
      answer:
        "We offer 24x7 security, lush parks, water bodies, a modern gym, a commercial center, medical care, and much more to ensure a luxury living experience.",
    },
    {
      faqnumber: 5,
      question: "What is Anugrah Homes?",
      answer:
        "Anugrah Homes is a premium residential project near Jewar International Airport & Film City Noida, offering luxurious amenities & modern facilities with a serene, nature-rich environment.",
    },
    {
      faqnumber: 6,
      question: "What features come with residential plots?",
      answer:
        "Accuracy, On-time Possession, Excellence in Architecture, Prime Location, and proximity to Nearby Attractions.",
    },
  ];
