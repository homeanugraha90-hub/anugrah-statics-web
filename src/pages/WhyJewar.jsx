...
const features = [
  ...
  {
    icon: <Building className="w-12 h-12 text-yellow-500" />,
  ...
  {
    icon: <School className="w-12 h-12 text-yellow-500" />,
...
const WhyJewar = () => {
              ...
              >
                ...
                {feature.animationType === 'plane' && (
                  <>
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-br from-blue-200 via-blue-100 to-white opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                      initial={{ scale: 0 }}
                    ...
                    {/* Flying Clouds */}
                    <motion.div
                      className="absolute top-4 left-0 w-8 h-4 bg-white rounded-full opacity-0 group-hover:opacity-70"
                      animate={{
                        x: [-50, 350],
                        y: [0, -10, 5, -5, 0]
                      }}
                    ...
                    />
                    <motion.div
                      className="absolute top-8 right-0 w-6 h-3 bg-white rounded-full opacity-0 group-hover:opacity-60"
                      animate={{
                        x: [350, -50],
                        y: [0, 5, -8, 3, 0]
                      }}
                    ...
                    {/* Flight Trail */}
                    <motion.div
                      className="absolute top-16 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-yellow-300 to-transparent opacity-0 group-hover:opacity-70"
                      animate={{
                        x: [-100, 100],
                        scaleX: [0, 1, 0]
                      }}
                ...
                {feature.animationType === 'car' && (
                  <>
                    ...
                    {/* Road Lines */}
                    <motion.div
                      className="absolute top-1/2 left-0 w-full h-1 bg-yellow-400 opacity-0 group-hover:opacity-100"
                      animate={{
                        x: [-100, 100]
                      }}
                      transition={{
                ...
                {feature.animationType === 'building' && (
                  <>
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-t from-orange-200 via-yellow-100 to-blue-100 opacity-0 group-hover:opacity-90 transition-opacity duration-500"
                    />
                    ...
                    <motion.div
                      className="absolute top-2 right-4 w-1 h-16 bg-yellow-600 opacity-0 group-hover:opacity-70 origin-bottom"
                      animate={{
                        rotate: [0, 45, -45, 0]
                      }}
                      transition={{
                ...
                {feature.animationType === 'school' && (
                  <>
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-br from-green-200 via-blue-100 to-yellow-100 opacity-0 group-hover:opacity-90 transition-opacity duration-500"
                    />
                    
                    {/* School Bell Ringing */}
                    <motion.div
                      className="absolute top-4 right-4 w-4 h-4 border-2 border-yellow-600 rounded-full opacity-0 group-hover:opacity-80"
                      animate={{
                        scale: [1, 1.3, 1],
                    ...
                    {[...Array(3)].map((_, idx) => (
                      <motion.div
                        key={idx}
                        className="absolute top-4 right-4 w-8 h-8 border border-yellow-400 rounded-full opacity-0 group-hover:opacity-60"
                        animate={{
                          scale: [1, 2 + idx, 3 + idx],
                          opacity: [0.6, 0, 0]
                        }}
                ...
                <h3 className="text-xl font-bold mb-3 relative z-20 group-hover:text-white transition-colors duration-500">
                  {feature.title}
                </h3>
                <p className="text-gray-600 text-sm relative z-20 group-hover:text-gray-100 transition-colors duration-500">
                  {feature.description}
                </p>
  ...
  <div className="space-y-6">
    ...
    <button className="mt-4 px-6 py-3 rounded-xl bg-yellow-500 text-white font-semibold shadow-lg hover:bg-yellow-600 transition-all duration-300">
      Explore More
    </button>
  </div>
  ...
  <div className="relative group">
    ...
    />
    {/* Overlay Glow Effect */}
    <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-yellow-400/20 to-yellow-600/10 opacity-0 group-hover:opacity-100 transition duration-500"></div>
  </div>
</section>
